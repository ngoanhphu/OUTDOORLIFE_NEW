...
<div class="container" style="margin-top: 200px">
    ...
    <div class="create-button-container">
        <button class="btn-create" onclick="window.location.href='createTentForm.jsp'">Create Gear</button>
    </div>
        ...
        <c:forEach var="g" items="${gears}">
            <div class="col-md-3 d-flex">
                <div class="card border-e shadow rounded-3 w-100">
                    <img class="card-img-top" src="img/${g.image}" alt="Gear image" />
                    <div class="card-body">
                        <h5 class="card-title">${g.name}</h5>
                        <h6 class="price">
                            <fmt:formatNumber value="${g.price}" type="currency"/>
                        </h6>
                        ...
                        <p><strong>Gear ID:</strong> ${g.gearId}</p>
                        <p><strong>Campsite Owner ID:</strong> ${g.campsiteOwner}</p>
                    </div>
                </div>
            </div>
        </c:forEach>
