    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (currentUser != null && currentUser.isOwner()) {
            ...
            try {
                ...
                TentDAO tentDAO = new TentDAO(con.getConnection());

                // Thêm lều vào cơ sở dữ liệu
                tentDAO.insertGear(name, price, description, imagePath, ownerId);

                // Chuyển hướng về trang admin sau khi thêm lều thành công
