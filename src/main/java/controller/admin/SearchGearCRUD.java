 ...
 * @author ADMIN
 */
@WebServlet(name = "SearchGearControl", urlPatterns = {"/searchGear"})
public class SearchGearCRUD extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SearchGearCRUD.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
